...
| <a name="input_defaut_addon_enabled"></a> [defaut\_addon\_enabled](#input\_defaut\_addon\_enabled) | Enable default addon(VPC-CNI, AWS-EBS-CSI-DRIVER) with Cluster creation | `bool` | `false` | no |
