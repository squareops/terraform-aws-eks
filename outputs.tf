...
#   value       = var.default_addon_enabled ? var.ng_capacity_type : null
# }
...
#   value       = var.default_addon_enabled ? var.ng_instance_types : null
# }
